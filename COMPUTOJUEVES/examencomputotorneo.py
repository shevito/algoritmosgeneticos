...
# Listas para almacenar las aptitudes mejores y peores para cada ejecución
all_best_aptitudes = []
all_worst_aptitudes = []
...
# Imprimir estadísticas después de todas las ejecuciones
print("Promedio de la mejor aptitud:", np.mean(all_best_aptitudes))
print("Promedio de la peor aptitud:", np.mean(all_worst_aptitudes))
print("Varianza de la mejor aptitud:", np.var(all_best_aptitudes))
print("Varianza de la peor aptitud:", np.var(all_worst_aptitudes))
