...
for iteration in range(n_iterations):
    ...
    # Print local best solution for the iteration
    print(f"Iteration {iteration + 1}: Best Local Solution Profit = {local_best_solution_profit}")
...
# Print the global best solution at the end
print("\nGlobal Best Solution:", global_best_solution)
